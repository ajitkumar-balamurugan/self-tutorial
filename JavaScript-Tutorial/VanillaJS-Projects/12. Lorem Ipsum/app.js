...
const theValue = document.getElementById("amount");
const paragraphs = document.querySelector(".lorem-text");

form.addEventListener("submit", (e) => {
  // console.log(e);
  e.preventDefault();
  let v = parseInt(theValue.value);
  // console.log(v);
